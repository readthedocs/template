...
Тестовые локальные сборки возможно производить в докер-контейнере `readthedocs/build <https://hub.docker.com/r/readthedocs/build/>`_. Последовательность команд, частично имитирующая сборку на сайте Read the Docs назодится в файле ``rtd-docker-build.sh``.
