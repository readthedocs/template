...
**Панель инструментов Eclipse** содержит инструменты для работы с редактором. Кнопка |file| позволяет открыть новый :ref:`sqlEditor`.
...
- ⯆ выбрать источник базы данных 

Кнопки ⯆ также позволяют запустить операции получения или применения изменений к БД с одноразовым переопределением некоторых настроек.
