...
latex_documents = [
  ('index', 'pgCodeKeeper.tex', u'pgCodeKeeper Documentation',
   u'pgCodeKeeper', 'manual'),
]
...
man_pages = [
    ('index', 'pgCodeKeeper', u'pgCodeKeeper Documentation',
     [u'pgCodeKeeper'], 1)
]
...
texinfo_documents = [
  ('index', 'pgCodeKeeper', u'pgCodeKeeper Documentation',
   u'pgCodeKeeper', 'pgCodeKeeper', 'One line description of project.',
   'Miscellaneous'),
]
