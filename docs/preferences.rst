...
Имена объектов, которые не должны учитываться при сравнении БД, можо указать на странице настроек **pgCodeKeeper -> Исключенные объекты**.
...
- **Белый список** – инвертировать ли черный список в белый
