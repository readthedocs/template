...
Учтенные все объекты при сравнении БД:

.. image:: ../images/ignore_list_diff.png

Используется иселючение по дополнительной настройке **Шаблон**:

.. image:: ../images/ignore_list_pattern.png
.. image:: ../images/ignore_list_pattern_diff.png

Используется иселючение по дополнительной настройке **Игнорировать содержимое**:

.. image:: ../images/ignore_list_content.png
.. image:: ../images/ignore_list_content_diff.png

Используется иселючение по дополнительной настройке **Тип** и **Шаблон**:
...
Для добавления хранилища нажать кнопку |add_obj|. Откроется диалог **Данные подключения к БД**, в котором нужно указать параметры данных подключения: название записи, имя БД, пользователь, пароль, хост, порт. Нажать на кнопку **OK**. На странице настроек нажать кнопку **Apply** или **OK** и хранилище БД будет сохранено.
